...
import Newbisec from "./components/Bracketing Method/Testbisection";
import Big from "./components/Bracketing Method/Big";
  ...
  return (
    <div>
      ...
      <BrowserRouter>
        ...
        <Route path="/testbisection" element={<Newbisec/>}/>
